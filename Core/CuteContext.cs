namespace Cinteros.Unit.Test.Extensions.Core
{
    ...
    public class CuteContext : IPluginExecutionContext
    {
        ...
        public CuteContext Parent { get; set; }
        ...
        /// <summary>
        /// Will cause the service generated from the ServiceProvicer containing this contect to be
        /// of type UnitTestService.
        /// </summary>
        public bool UseUnitTestService { get; set; }
